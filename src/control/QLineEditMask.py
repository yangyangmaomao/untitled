...
class QLineEditMask(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('用掩码限制LineEdit控件的输入')
        ...
        licenseLineEdit.setInputMask('>NNNNN-NNNNN-NNNNN-NNNNN')

        formLayout.addRow(ipLineEdit)
        formLayout.addRow(macLineEdit)
        formLayout.addRow(dateLineEdit)
        formLayout.addRow(licenseLineEdit)
